...
groupMemberForumConnection.onopen = (event) => {
    console.log(event.data);
}

groupMemberForumConnection.onclose = (event) => {
    console.log(event.data);
}

groupMemberForumConnection.onerror = (event) => {
    console.error(event.data);
}

groupMemberForumConnection.onmessage = (event) => {
...
// TODO: GET ALL THE  MESSAGES FROM THE APPROPRIATE END POINT(ASYNC)
    ...
    try {
        ...
        console.error(error);
        groupMemberForumConnection.close();
    }
}
