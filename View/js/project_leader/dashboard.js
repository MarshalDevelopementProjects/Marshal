...
todoBoard.innerHTML = getTodoTasksCode(todoTasks);


function getongoingCode(ongoingTasks){
    let ongoingTasksCode = "";
    ...
    return ongoingTasksCode;
}
ongoingBoard.innerHTML = getongoingCode(ongoingTasks);


function getReviewTasksCode(reviewTasks){
    let reviewTasksCode = "";
    ...
    return reviewTasksCode;
}
reviewBoard.innerHTML = getReviewTasksCode(reviewTasks);


function getDoneTaskCode(doneTasks) {
    let doneTasksCode = "";
    ...
    return doneTasksCode;
}
doneBoard.innerHTML = getDoneTaskCode(doneTasks);
